...
2. After installation run '00-backup_freelcs_configuration.sh' to make a backup of the installation settings. Files needed for restoration and a restoration script will be created in dir 'freelcs_backup'.

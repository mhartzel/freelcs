...
# Limit the maximum size of the incoming request to 100 KB to prevent Memory Exhaustion (DoS) attacks.
...
loudness_correction_program_info_and_timestamps = {} # This dictionary stores LoudnessCorrection.py - program info and latest timestamps received from Loudness_Correction.py
